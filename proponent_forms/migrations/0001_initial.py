    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_model', models.CharField(blank=True, choices=[('geo.Country', 'País'), ('common.Status', 'Estado'), ('thematic_axes.ThematicAxis', 'Eje Temático')], max_length=100, null=True, verbose_name='Modelo de Origen')),
