    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_type', models.CharField(choices=[('text', 'Texto largo'), ('short_text', 'Texto corto'), ('number', 'Número'), ('boolean', 'Sí/No'), ('dropdown', 'Desplegable'), ('radio', 'Opción múltiple')], default='text', max_length=20, verbose_name='Tipo de Campo')),
                ...
                ('source_model', models.CharField(blank=True, choices=[('geo.Country', 'País'), ('common.Status', 'Estado'), ('thematic_axes.ThematicAxis', 'Eje Temático')], help_text="Si se selecciona, carga opciones desde este modelo. (Ignorar para 'Opciones Estaticas')", max_length=100, null=True, verbose_name='Modelo de Origen')),
